...
namespace AscheLib.UI {
	...
	[AddComponentMenu("UI/Effects/UIInvertColorEffect")]
	class UIInvertColorEffect : UIGrabPassEffectBase {
		// しきい値
		...
		// 使用するシェーダー名
		protected override string shaderName => "Hidden/UI/GrabPass/InvertColor";
